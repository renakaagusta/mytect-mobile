...
class AppColors {
  ...
  static const PrimaryColor = const Color(0xffffa827);
  static const PrimaryColorLight = const Color(0xFFfcc454);
  static const PrimaryColorDark = const Color(0xFF7f0000);

  static const SecondaryColor = const Color(0xFFfcc454);
